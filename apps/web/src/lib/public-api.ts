...
export type PublicArchiveIndex = { categories:{slug:string;title:string;description:string|null;translationKey:string;articleCount:number;featured:PublicArticleSummary[]}[]; tags:{slug:string;title:string;translationKey:string}[]; authors:{slug:string;title:string}[] };
