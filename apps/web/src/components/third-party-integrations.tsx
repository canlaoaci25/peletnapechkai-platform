...
export function ThirdPartyIntegrations(){
 ...
 return <>
  ...
  {allowed&&adsense&&/^ca-pub-\d+$/.test(adsense)&&<Script id="boecl-adsense" async crossOrigin="anonymous" src={`https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=${adsense}`} strategy="afterInteractive"/>}
