...
type JobReport = { id:string;type:string;status:string;targetLocales:string[];totalItems:number;completedItems:number;failedItems:number;currentPhase:number;lastMessage:string|null;reportText:string|null;createdAt:string;updatedAt:string;completedAt:string|null };
const names:Record<string,string>={ContentTranslation:"Otomatik içerik çevirisi",SeoLocalization:"Otomatik SEO yerelleştirmesi",SiteLocalization:"Otomatik site dili",SystemReport:"Otomatik sistem raporu"};
